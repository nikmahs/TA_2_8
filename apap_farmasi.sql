...
-- Database: 'apap_ta'
--
CREATE DATABASE IF NOT EXISTS `apap_farmasi` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `apap_farmasi`;
...
INSERT INTO `permintaan` (`id`, `tanggal`, `id_medical_supplies`, `jumlah_medical_supplies`, `id_jadwal`, `id_status_permintaan`, `id_pasien`) VALUES (2, '2018-11-18', 5, 60, 2, 1, 122);
...
INSERT INTO `permintaan` (`id`, `tanggal`, `id_medical_supplies`, `jumlah_medical_supplies`, `id_jadwal`, `id_status_permintaan`, `id_pasien`) VALUES (4, '2018-12-2', 12, 90, 5, 1, 121);
INSERT INTO `permintaan` (`id`, `tanggal`, `id_medical_supplies`, `jumlah_medical_supplies`, `id_jadwal`, `id_status_permintaan`, `id_pasien`) VALUES (5, '2018-12-14', 19, 30, 7, 1, 120);
